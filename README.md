...
- MCP capabilities: Chabeau currently advertises no optional client capabilities (roots, sampling, tasks, elicitation). It respects server capabilities for tools/resources/prompts when provided, and otherwise falls back to method-not-found handling.
